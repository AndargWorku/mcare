            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text__para">
                  ...
                  recusandae alias fugit animi molestias corrupti voluptas quia
                  temporibus quidem molestiae ab sequi, quibusdam perspiciatis
                  eveniet tenetur? Reprehenderit aut tempore natus!
                </p>
      ...
      <section>
        <div className="container">
          <div className="xl:w-[470px] mx-auto">
            ...
            <p className="text__para text-center">
              world-class care for every one our healthy system offered
              unmatched
            </p>
          </div>
          <ServiceList />
            ...
            <div className="xl:w-[670px]">
              ...
              <ul className="pl-4">
                ...
                <li className="text__para">
                  ...
                  online scheduling tool select an appointment time
                </li>
              </ul>
              <Link to="/">
