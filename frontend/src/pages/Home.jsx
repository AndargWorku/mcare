  ...
  <div className="container">
   ...
   world class care for every one . our health System offers unmatched
    ...
    <div className="py-[30px] px-5">
     ...
     <div className="mt-[30px]">
      <h2 className="text-[26px] leading-9 text-headingColor font-[400] text-center">
        Find a Doctor
      </h2>
      <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
        world class care for every one. Our health System offers unmatched,expert health care. from the lab to the Clinic 
      </p>
   ...
   <section>
    <div className="container">
      <div className="xl:w-[470px] mx-auto">
        ...
        <p className="text__para text-center">
          world-class care for every one our healthy system offered unmatched 
        </p>
      ...
      <div className="flex items-center justify-between flex-col lg:flex-row">
        ...
        <div className="xl:w-[670px]">
          ...
          <ul className="pl-4">
            ...
            <li className="text__para">3. view our physicians who are accepting new patients use the online scheduling tool select an appointment time</li>
